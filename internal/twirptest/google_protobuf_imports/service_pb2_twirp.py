...
class SvcClient(object):
    ...
    def send(self, string_value):
        serialize = _sym_db.GetSymbol("google.protobuf.StringValue").SerializeToString
        deserialize = _sym_db.GetSymbol("google.protobuf.Empty").FromString

        full_method = "/{}/{}".format(self.__service_name, "Send")
        body = serialize(string_value)

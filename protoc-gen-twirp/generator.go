...
import (
	...
	"github.com/guide-century/twirp/internal/gen"
	"github.com/guide-century/twirp/internal/gen/stringutils"
	"github.com/guide-century/twirp/internal/gen/typemap"
)
...
func (t *twirp) generateFileHeader(file *descriptor.FileDescriptorProto) {
	...
	if t.filesHandled == 0 {
		...
		t.P("This code was generated with github.com/guide-century/twirp/protoc-gen-twirp ", gen.Version, ".")
		t.P()
...
func (t *twirp) generateImports(file *descriptor.FileDescriptorProto) {
	...
	t.P(`import `, t.pkgs["twirp"], ` "github.com/guide-century/twirp"`)
	t.P(`import `, t.pkgs["ctxsetters"], ` "github.com/guide-century/twirp/ctxsetters"`)
	t.P()
